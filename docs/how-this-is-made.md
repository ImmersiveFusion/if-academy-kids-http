...
The same way as everything else, described in our [editorial commitments](commitments.md): when we get something wrong, we say so on the same page, dated, and we do not delete the original. A mistake the AI made and a mistake a person made are fixed the same way, because to your kid they are the same mistake, and either way it is ours to fix. If you spot one, you can write to us at [academy@immersivefusion.com](mailto:academy@immersivefusion.com), and we will answer.
